...
//converter_3d_csv::motion_pose_frame_record::motion_pose_frame_record(rs2_stream stream_type, int stream_index,
...
//std::string converter_3d_csv::motion_pose_frame_record::to_string() const
//{
//    std::stringstream ss;
...
//std::string converter_3d_csv::get_time_string() const
//{
//    auto t = time(nullptr);
//    char buffer[20] = {};
...
//}
//
//void converter_3d_csv::save_motion_pose_data_to_file()
//{
...
//void converter_3d_csv::convert_motion_pose(rs2::frame& f)
//{
